...
def load_metadata_with_batch(
    ...
    if meta_type == "PROT":
        ...
        raise ValueError(
            f"meta_type must be 'PROT', 'placenta', 'MTBL', or 'LIPD', "
            f"got '{meta_type}'"
        )
    ...
    if meta_type == "PROT" and "sample gest Age" in meta_subset.columns:
...
# -----------------------------
''' 
    Need to add the dropped assays from this section to the missingness report
'''
