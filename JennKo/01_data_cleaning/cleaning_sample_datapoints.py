...
dp3_age = pd.read_excel("/Users/jennko/Desktop/Penn/Piekos Lab/data/dp3 master table v2.xlsx", sheet_name="n=133 proteomics")
dp3_clinical = pd.read_excel("/Users/jennko/Desktop/Penn/Piekos Lab/data/dp3 master table v2.xlsx", sheet_name="clinical data", header=1)
print(dp3_clinical)

###Data Processing
##Calculating differences in gestational age between delivery and sample collection
dp3_age=dp3_age[['ID','sample Id','gest age del','sample gest Age']].copy()
...
##When add delviery samples, they trigger if statement first 
